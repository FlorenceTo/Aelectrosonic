...
const interviews = [
  // -------- INTERVIEW 1 (your full original transcript) --------
  {
    ...
    transcript: [
      ...
      { speaker: "B", text: "So this struggle between the indigenous people and what they want and the colonisers and what they want, we are at that, at that nexus of the struggle.", timestamp: "00:06:06,000 → 00:06:08,000" },
      ...
      { speaker: "B", text: "That's a very good question and something we have on our priorities for the coming year or two.", timestamp: "00:07:16,000 → 00:07:19,000" },
      ...
      { speaker: "B", text: "So I think the use of technology is a critical component of our work, even when they try to restrict it.", timestamp: "00:07:34,000 → 00:07:41,000" },
      ...
      { speaker: "B", text: "There's a friend of mine, Basil Khoury, who's going to come.", timestamp: "00:09:25,000 → 00:09:38,000" },
      { speaker: "B", text: "Today I wanted him to talk to you and to us about Internet security and things like that.", timestamp: "00:09:38,000 → 00:09:54,000" },
      ...
      { speaker: "A", text: "Have you noticed any changes in species behaviours, seasonal rhythms and biodiversity that are not adequately captured by international environmental narratives?", timestamp: "00:13:57,000 → 00:14:03,000" },
      ...
      { speaker: "B", text: "It's kind of tongue-in-cheek title by an environmentalist actually who realised he's Western, I think he's Australian.", timestamp: "00:14:21,000 → 00:14:30,000" },
      ...
      { speaker: "A", text: "Bird migration creates invisible networks in the sky, connecting Palestine to Africa, Europe, and Asia.", timestamp: "00:19:44,000 → 00:19:53,000" },
      ...
      { speaker: "A", text: "I recently went to the Caesarea archaeological site in the desert Al-Zarqa, and there was a fish farming site nearby where there were so many birds because of all the fish.", timestamp: "00:21:34,000 → 00:21:44,000" },
      ...
      { speaker: "B", text: "We did one study, by the way, with an intern here, who looked at the book, old book by Tristram, who described birds in Palestine and compared what Tristram observed in 1865 with what we observe today in terms of birds and bird migrations and so forth.", timestamp: "00:22:05,000 → 00:22:08,000" },
      ...
      { speaker: "B", text: "So we really need to rethink our policies as humans. And we the indigenous people try to tell the colonisers and anybody who would listen, you're not doing even yourself as a coloniser a favor by doing this.", timestamp: "00:23:10,000 → 00:23:14,000" },
      ...
      { speaker: "A", text: "Like fast engineering, they only care about fast engineering.", timestamp: "00:23:49,000 → 00:23:55,000" },
      ...
      { speaker: "A", text: "I'm looking at the air that becomes restricted and also as the last remaining space of ecological continuity because there's restricted zones in the sky, but for birds, they can still fly through those restricted zones.", timestamp: "00:24:28,000 → 00:24:38,000" },
      ...
      { speaker: "B", text: "There are also the mental borders people create in their own minds. We ask ourselves: am I connected to someone living in Hong Kong?", timestamp: "00:27:13,000 → 00:27:22,000" },
      ...
      { speaker: "A", text: "And also in your papers on militarisation, because now thinking about the scarred landscape, the scarred air, the scarred organisms that we're living in.", timestamp: "00:27:44,000 → 00:27:50,000" },
      { speaker: "A", text: "You often describe the landscape as shaped by militarisation, walls, firing zones, settlements, military bases.", timestamp: "00:27:50,000 → 00:27:57,000" },
      ...
      { speaker: "A", text: "But this is also militarisation as well. This ideology of militarisation is using walls.", timestamp: "00:28:01,000 → 00:28:07,000" },
      ...
      { speaker: "A", text: "How is the militarisation deepening the scars?", timestamp: "00:28:17,000 → 00:28:20,000" },
      ...
      { speaker: "B", text: "That's where you see militarisation comes in, militarisation of police in the US, for example, with ICE agents that just killed a woman, 37-year-old mother in Minneapolis.", timestamp: "00:30:07,000 → 00:30:16,000" },
      ...
      { speaker: "B", text: "So I think it's critical that we understand the connection of militarisation and why Donald Trump now wants to increase the military budget from $1 trillion to $1.5 trillion.", timestamp: "00:30:47,000 → 00:30:52,000" },
      ...
      { speaker: "B", text: "It has to do with this militarisation and this keeping us busy thinking about the Venezuelan people sending drugs to America.", timestamp: "00:31:40,000 → 00:31:46,000" },
      ...
      { speaker: "A", text: "Because you have worked with different organisations, such as Yossi Lesham who was in charge of the Aerial networks in the past.", timestamp: "00:31:57,000 → 00:32:04,000" },
      { speaker: "A", text: "You're more resilient about how you are spreading your knowledge and who you're sharing it with.", timestamp: "00:32:04,000 → 00:32:12,000" },
      { speaker: "A", text: "I want to understand the complexities of this because as a Palestinian, you want to bring the resistance back to the land and the justice.", timestamp: "00:32:12,000 → 00:32:17,000" },
      { speaker: "A", text: "I want to understand the complexities that are involved in this.", timestamp: "00:32:17,000 → 00:32:20,000" },
      { speaker: "A", text: "Such as your collaborations with looking after ecological biodiversity because you're in occupied Palestine.", timestamp: "00:32:28,000 → 00:32:32,000" },
      ...
      { speaker: "A", text: "With your collaborations, you're also trying to withstand normalisation.", timestamp: "00:35:14,000 → 00:35:20,000" },
      { speaker: "A", text: "You don't want a normalisation, a globalisation of militarisation or being restricted from your land as well.", timestamp: "00:35:20,000 → 00:35:26,000" },
      ...
      { speaker: "B", text: "Because we show that you cannot normalise with people who are destroying our planet.", timestamp: "00:35:32,000 → 00:35:37,000" },
      { speaker: "B", text: "You cannot normalise with people who are destroying the planet.", timestamp: "00:35:37,000 → 00:35:42,000" },
   ...
   // -------- INTERVIEW 4: Yossi Leshem (NEW) --------
  {
    ...
    transcript: [
      ...
      { speaker: "B", text: "You do know that I did a big research for the Israeli Air Force, when I was using a Russian radar, and I was using a radar in Ben Gurion Airport, and the two radars of the Air Force. Do you know a professor in Haifa University, Nir Sapir?", timestamp: "00:01:20" },
      { speaker: "A", text: "No, I don't.", timestamp: "00:01:39" },
      { speaker: "B", text: "So Nir Sapir has now two or three students who are following my study with more radars, more models, and much more efficient new stuff. I would suggest that you call and talk to him.", timestamp: "00:01:41" },
      ...
      { speaker: "A", text: "Let me start from the first question. Tell me about yourself, and how you started.", timestamp: "00:04:07" },
      { speaker: "B", text: "I'm retired. I'm 78 years old. I've been retired for 11 years, but I'm still working with the Air Force, and I'm still working in the university, because I'm involved in quite a lot of other projects too.", timestamp: "00:04:27" },
      { speaker: "A", text: "Thanks for sending me your film, Flying with Birds. It raised many questions about how bird migration and aviation intersect with the complexities of governance. In terms of collaboration, it can be quite difficult when it comes to protecting birds. I'm trying to understand these complexities, and also working with spatial analysis, so when looking at radar technologies, your name came up quite a lot.", timestamp: "00:04:43" },
      { speaker: "A", text: "I've been researching bird migration for a few years now. I'm not a bird specialist, because I primarily work as a researcher and artist, looking at conditions in the air commons, but also looking at how we sense with sound, as well as working with other species – not just humans connecting with each other, but also multi-species connection. You have a very trans-disciplinary background, because you work with birds and radar technology, which is why I'm getting in touch with you.", timestamp: "00:05:28" },
      { speaker: "B", text: "I did a study for the Israeli Air Force. They lost a lot of aircraft colliding with birds, mainly on migration. They lost 11 aircraft, and three pilots were killed, and they have thousands of collisions. I was leading a study. This was my PhD, in fact. I was studying migration with a motorised glider. I flew with a motorised glider to measure the thermals from the bottom to the top of the thermal. Every day for 252 days, from the Egyptian border to the Lebanese border, every day with one flock of pelicans, raptors, different species, white storks, and black storks.", timestamp: "00:06:08" },
      { speaker: "B", text: "I used birdwatchers – I put them across the country, from the Mediterranean to the Rift Valley, every kilometre or two, two birders. I was using, for the first time ever, drones – unmanned aircraft. And all this information I put into one database, and I used for the first time ever in the Middle East radars. I started with a radar in the international airport. There was an approaching radar which had a wavelength that was perfect.", timestamp: "00:07:02" },
      { speaker: "B", text: "Then, when there was the big immigration of Jews from Russia – 1.1 million came to the Middle East in 1991 – I found a general who was the head of weather radars in Russia, so he brought one of those radars. It's an ML-5 radar. I have many papers on this. You can read them. We put it in Latrun, which is on the middle of the way, where the armour memorial site is. It's still there. From 1997 until five years ago, we followed, seven months a year, the migration in spring and autumn.", timestamp: "00:07:37" },
      { speaker: "B", text: "We developed with the Russian general an algorithm so you can see the flux up to 100 kilometres in each direction. All this was documented. Then we made new regulations of flight for the Air Force: not to fly where the birds are – on the height, on the time, on the routes. The number of collisions dropped by 76%.", timestamp: "00:08:23" },
      { speaker: "B", text: "So that was the first stage of my work. But I was also doing cooperation with Palestinians and Jordanians. I have a big project with the Barn Owl – a pest control agent, but not migration. Because people in the Middle East use a lot of pesticides. To reduce that, we made nesting boxes. We now have in Israel 5,000 nesting boxes. In Palestine, about 60. In Jordan, about 400. And now also Morocco, Greece, and Cyprus. All of them are in one network following the Barn Owl project to reduce pesticide use.", timestamp: "00:08:50" },
      { speaker: "B", text: "But with the radar stuff, after we finish talking, I will send you the email of Professor Nir Sapir. You can get more information on what is going on right now with radars, okay? There is a PhD student who developed models on how to follow migration. You can also talk to her. They will tell you about all of them.", timestamp: "00:09:31" },
      { speaker: "A", text: "Also on the pesticide situation – why is there a lot of pesticides at the moment? Where are they coming from?", timestamp: "00:09:48" },
      { speaker: "B", text: "There is a black market where farmers buy pesticides, spray them, killing wildlife and affecting the environment and people, of course. Because if they spray, for example, alfalfa (a legume grown as livestock feed), they feed the cows with that alfalfa, then it ends up in the milk. It kills wildlife, contaminates soil and water. So we wanted to reduce it dramatically. But now, because of the bad situation between Palestine and Israel, we cannot work together. I organised many meetings and seminars, but that's it. It's a horrible situation at the moment.", timestamp: "00:09:55" },
      { speaker: "A", text: "I think right now these conservation efforts are becoming quite dire – because no one can really work together, sharing data and conservation work.", timestamp: "00:10:44" },
      { speaker: "B", text: "Including the guy from the bird monitoring station. He hates Israel. He doesn't want us to come there. He doesn't want any cooperation because of the situation. But there are quite a lot of Palestinians who want to cooperate. But, you know, that's his message.", timestamp: "00:11:06" },
      { speaker: "B", text: "The collection of stuffed birds – I don't know if he showed you the stuffed birds from 110 years ago, or just the ringing station.", timestamp: "00:11:38" },
      { speaker: "A", text: "I saw some of them.", timestamp: "00:11:57" },
      { speaker: "A", text: "Can you tell me how you first became involved in studying bird migration in relation to aviation and airspace?", timestamp: "00:12:21" },
      { speaker: "B", text: "I did my master's on a local bird that was declining. We have a big organisation in Israel, the Society for the Protection of Nature in Israel – SPNI. I was working for them before I went to the university. I was the CEO, the general director. I fell in love with birds. I knew my career would be with birds. So I established a bird club in Jerusalem for children. We had hundreds of them.", timestamp: "00:12:29" },
      { speaker: "B", text: "After my master's, I looked for a topic. I learned that migration is a big story for the Middle East – in Israel, but also in Palestine and Jordan. I suddenly learned that the Air Force had many problems with collisions, mainly with migrating birds. So I went into that. Then I also worked with the Barn Owl project. When I learned about the pesticide problem, I said I would lead a big project. I have a big partner from Lausanne University, Professor Alexandre Roullin, and we are doing it together.", timestamp: "00:13:00" },
      { speaker: "A", text: "At what point did radar and collaboration with pilots or the Air Force become central to your work?", timestamp: "00:13:43" },
      { speaker: "B", text: "Since I started, 1983.", timestamp: "00:13:51" },
      { speaker: "A", text: "Because your master's degree wasn't directly working with technology in the beginning, was it?", timestamp: "00:14:00" },
      { speaker: "B", text: "No, it was just watching in the field and trying to find out why this species was declining – also because of pesticides, hunting, habitat destruction. And people from the West Bank were stealing chicks from nests and stuff like that.", timestamp: "00:14:08" },
      { speaker: "A", text: "In the video you showed me, Flying with Birds, you're also in a plane testing…", timestamp: "00:14:23" },
      { speaker: "B", text: "It's a motorised glider. I was flying with the migrating birds with the motorised glider. It had a motor; I took off. My staff located the birds on the Egyptian border in spring migration. Then I took off and started soaring with the birds in the thermals, along with the same flock every day, between five and nine hours.", timestamp: "00:14:29" },
      { speaker: "A", text: "So that was a daily routine? You saw the film – it tells you all the information. But back in the day, before the rise of technology, doing fieldwork with birds required spending a lot of time with them. Now we have different devices that allow us to spend less time with birds.", timestamp: "00:14:55" },
      { speaker: "B", text: "I also worked after that, between 1996 and 2004, with GPS. We put GPS radio transmitters, satellite transmitters, on white storks from Germany. I got one and a half million dollars from the Germans, from the Minister of Environment, and I gave money to the Palestinians. At that time, I don't know if you met Imad Atrash from Beit Sahour.", timestamp: "00:15:21" },
      { speaker: "A", text: "No, he's not here right now. I think he's not in town. But someone else also recommended him.", timestamp: "00:15:45" },
      { speaker: "B", text: "So I started with him. Because it was online, Palestinian, Jordanian, and Israeli schools could cooperate and follow the white storks from Germany online. I also developed it at Talitha Kumi with the school manager. I gave them the money for a classroom with 25 computers. They also learned from that when we met together. But this was before the second Intifada, in the 1990s. Then they started the aggression. We couldn't go there. Simon was one of the people we trained because we wanted to make a ringing station in Jericho. But he decided to work in Talitha Kumi. He didn't want any contact with Israelis.", timestamp: "00:15:53" },
      { speaker: "A", text: "With this power you cannot achieve anything, unfortunately. It's understandable with the oppression over such a long time.", timestamp: "00:16:46" },
      { speaker: "A", text: "Let's look at the practice of radar and scientific methods – this is something very integral to your work.", timestamp: "00:17:00" },
      { speaker: "B", text: "The GPS work was a big story.", timestamp: "00:17:11" },
      { speaker: "A", text: "Please tell me more about GPS, because now 5G, 6G are coming. It started with 1G, 2G.", timestamp: "00:17:15" },
      { speaker: "B", text: "I got the money to follow the migration route. I did it with the Max Planck Institute for Ornithology, Professor Peter Berthold, a big name in this field. Then I went to the Ministry of Education and they matched the funds. I also used it as an educational tool – so students could follow and understand how important migration is over the Middle East. We used it as a tool to bring Palestinians, Jordanians, and Israelis together – the students. Suddenly we took them into the field in the Beit She'an Valley. They were talking together on the internet. This was also a tool for breaking the ice and becoming friends. It worked very well. It was a big story.", timestamp: "00:17:20" },
      { speaker: "B", text: "But now, unfortunately, I cannot work with Talitha Kumi, even though the director is a friend of mine – the guy from Berlin. The collection of stuffed birds there was made by an Israeli professor. He said it has great historical importance. It was from 1917, about 110 years ago. The stuffed birds are standing outside. Maybe we give you new stuffed animals there because you use them for education. These have great importance for documentation, but they don't want them. I told you, 115 years ago, Israel Aharoni – considered the first Hebrew zoologist – collected them. But he collected them from the council in Sweden. So the collection was by the Lutheran Church, and then they gave it to Talitha Kumi. It belongs to the bishop.", timestamp: "00:18:04" },
      { speaker: "B", text: "And with the GPS – when was the first GPS? In Israel, in my study, 1996.", timestamp: "00:18:55" },
      { speaker: "A", text: "Was that 1G? In terms of signal tracking?", timestamp: "00:19:05" },
      { speaker: "B", text: "I can't remember how many – it starts from 1G, 2G, 3G, 4G. GPS is getting stronger based on the signal. So listen, I will send you the papers. You can look at them.", timestamp: "00:19:10" },
      { speaker: "A", text: "When you began working with radar for bird monitoring, what systems were being used and what had to be adapted or developed specifically for birds?", timestamp: "00:19:27" },
      { speaker: "B", text: "I used the radar first in Ben Gurion Airport. They had a spare screen, so they gave me permission. I brought three soldiers from the Israeli Air Force. They sat all the time taking photos. We didn't have to do anything. We could see the birds very easily. No technology needed. But using them, we could give warnings to air bases: 'Here a big flock is coming' – and they would stop take‑offs and landings.", timestamp: "00:19:36" },
      { speaker: "B", text: "Later, as I told you, the Russian radar in Latrun – the Russian immigrant came, he brought one radar. Then he made an algorithm that can see the birds very well, not weather. We worked with it until five years ago when he retired. That's it. The radar stands there, but it's not in use. However, the Air Force bought more radars for the north, the south, and the centre of Israel.", timestamp: "00:20:04" },
      { speaker: "A", text: "So you started with Israeli soldiers not doing anything, just taking pictures?", timestamp: "00:20:35" },
      { speaker: "B", text: "Yeah.", timestamp: "00:20:40" },
      { speaker: "A", text: "Did they have to take a picture every five minutes? How did this work?", timestamp: "00:20:42" },
      { speaker: "B", text: "Every ten minutes – a picture every ten minutes.", timestamp: "00:20:47" },
      { speaker: "A", text: "And this was a way to understand how to work with data?", timestamp: "00:20:50" },
      { speaker: "B", text: "Yeah.", timestamp: "00:20:53" },
      { speaker: "A", text: "From your perspective, how does bird monitoring radar differ from other aviation or defence radar systems? Because these radar systems can detect birds and help create flight paths that avoid collisions. But with this bird monitoring radar, does it differ from other aviation or defence radar systems?", timestamp: "00:20:57" },
      { speaker: "B", text: "Of course, you have to get a radar with a wavelength that can see birds. The Russian radar, for example, had wavelengths of three centimetres and ten centimetres, which was perfect for identifying birds. Some radars are too sophisticated – you cannot see birds, or you see too much noise. So you need a radar adapted for bird migration. I was lucky to work with two such radars, which were perfect. But weather radars, most of them are also good for following birds. For example, in the United States, they have NEXRAD radar. That's a Doppler radar, and they can follow birds with 167 radars across the US. Look up NEXRAD radar.", timestamp: "00:21:20" },
      { speaker: "A", text: "N-E-X-R-A-D? How old is it?", timestamp: "00:22:12" },
      { speaker: "B", text: "Not very old – about 20 or 30 years.", timestamp: "00:22:19" },
      { speaker: "A", text: "How much interpretation is required when reading radar data on birds? Where does human expertise remain essential?", timestamp: "00:22:24" },
      { speaker: "B", text: "What kind of bird movements can radar sense well? Where does it fall short? For example, does it sense large birds better than small ones? It depends on the bird's weight and wing span. The bigger the bird, the better the radar can identify it, of course, and at longer distances. We could see white storks from 100 kilometres. But we could see the vectors only from 15 kilometres. It depends on how many water molecules they have in their body.", timestamp: "00:22:33" },
      { speaker: "A", text: "So there's no way it could mistake a bird for a drone, because a drone has no water?", timestamp: "00:23:09" },
      { speaker: "B", text: "Yeah, of course. When you follow birds, you can see direction and velocity. So if you see something moving at 35 kilometres per hour, it's not an aircraft – it's a bird. But radars can sometimes see insects too.", timestamp: "00:23:14" },
      { speaker: "A", text: "How much interpretation is required when reading radar data on birds? Where does human expertise remain essential? Because you know how birds move, how organisms move.", timestamp: "00:23:33" },
      { speaker: "B", text: "If you work with radar, you have to be an expert and start to understand what are clouds, what are birds, what are insects, and what is nothing – or what is just trash from the mountains. But if you work on the same radar and get to know it, you can learn its benefits and disadvantages.", timestamp: "00:23:45" },
      { speaker: "A", text: "Once migration patterns became more visible through radar, how did this knowledge affect flight paths or training routines?", timestamp: "00:24:07" },
      { speaker: "B", text: "I told you – after we got the radar and could see long distances, they stopped flying there. They didn't fly along those routes or at those heights. Immediately, the number of collisions dropped by 76%.", timestamp: "00:24:17" },
      { speaker: "A", text: "Is it still dropping or has it changed?", timestamp: "00:24:33" },
      { speaker: "B", text: "No, that's basically the situation. It's stayed the same since 1984.", timestamp: "00:24:36" },
      { speaker: "A", text: "So even since the war broke out, there haven't been any more bird collisions at all?", timestamp: "00:24:44" },
      { speaker: "B", text: "There are, but at a much lower level.", timestamp: "00:24:50" },
      { speaker: "A", text: "What kind of birds are involved? The larger ones?", timestamp: "00:24:56" },
      { speaker: "B", text: "Yes. The larger the bird, and the faster the aircraft flies, the greater the impact.", timestamp: "00:25:00" },
      { speaker: "A", text: "Would that be griffon vultures or eagles?", timestamp: "00:25:07" },
      { speaker: "B", text: "No, no. Even buzzards or falcons. Griffon vultures weigh about eight kilos, but even a falcon weighing 500 grams can cause damage if it penetrates the engine. But if it's a warbler, which weighs only seven grams, it doesn't affect the aircraft. It kills the bird, but nothing happens to the aircraft.", timestamp: "00:25:10" },
      { speaker: "A", text: "During your time, were there any concrete moments where ecological data directly changed military planning or airspace use?", timestamp: "00:25:36" },
      { speaker: "B", text: "Yes, of course. But I also studied the weather. The weather had an impact – for example, during a hamsin (خمسين, khamsīn), a hot, dusty wind, birds don't fly at high altitudes. If there are eastern winds, they get drifted. So there is an average route, but sometimes it can move west or east – it depends on the weather. If there is stability in the atmosphere, they can fly much higher. Most of the thermals are up to 5,000 feet above ground level, but sometimes birds can fly even at 35,000 feet. They catch fast movements and can go even faster. But most of the time they fly between 1,000 and 5,000 feet.", timestamp: "00:25:45" },
      { speaker: "A", text: "I think we just talked about collaboration under complex conditions. In this region, scientific collaboration often takes place under very complex political and administrative conditions. How does that shape what collaboration can look like?", timestamp: "00:27:00" },
      { speaker: "B", text: "Which collaboration – with Palestinians?", timestamp: "00:27:15" },
      { speaker: "A", text: "Yes. And also with Israelis, because your stance is that you care about birds as well.", timestamp: "00:27:18" },
      { speaker: "B", text: "The big story is we don't have peace. When you have peace and work together, you do a much better job. You get more funds, more information, you can do everything much better. If you are separate, you lose, of course. Especially since the Palestinians don't have a team and experts like we have in Israel. So we could share all this data and information, help them, become friends, and work together as we did in the past. But now, you know, what happened in the Gaza Strip – we are slaughtering and destroying Gaza. This is a disaster for us and for them, a big disaster. And now many Israelis say, after October 7th, you cannot trust them – they will come again and try to exterminate Israel. So no one wants peace. And some settlers are going and affecting the Palestinians, which is terrible.", timestamp: "00:27:25" },
      { speaker: "A", text: "Just one more question. In occupied Palestine, Palestinians have many restrictions on how much data they can actually obtain. For example, if they go birdwatching with binoculars or recording equipment, the Israeli military prevents them from doing such activity, as if it were illegal – but it's not illegal. So they can't really go birdwatching. Even their autonomy is taken away. They cannot generate their own data, at least not completely, especially in the migration region. Under these conditions, what difficulties or limits emerge when you try to create ecological research? Because you need to collaborate across regions. You said you worked with schools, with Jordanians, with Palestinians in the past. Now the situation is dire because everyone is in pain. The slaughtering is causing so much trauma and pain for everyone. What have you fought for? You are having these conversations, but one person cannot change the world. In what sense can you collaborate – a collaboration where you can understand these traumas – especially under these structural constraints under Israeli authority? What do you think can be done?", timestamp: "00:28:30" },
      { speaker: "B", text: "Nothing. You just have to get people to understand, to meet each other, to become friends. Otherwise, if you have someone like Simon who sees an Israeli and immediately gets nervous, then you can do nothing with such a person. You need people who want to collaborate and work together – then it will work. And we are missing them on both sides now. That's it.", timestamp: "00:29:45" },
    ],
  },
  ...
  // -------- INTERVIEW 5: Layla (Ein Qiniya Walking Interview) --------
  {
    ...
    transcript: [
      ...
      { speaker: "A", text: "What I'm interested in is not only information, but how knowledge is carried in practice – in walking, in pointing things out, in listening to the environment, and in how places are explained while moving through them.", timestamp: "00:00:35" },
      { speaker: "A", text: "This is the embodied part of our conversation, but it is also an open form.", timestamp: "00:00:57" },
      { speaker: "A", text: "If you would like to start by introducing yourself and how you position yourself.", timestamp: "00:01:07" },
      { speaker: "B", text: "I'm Layla. I am a Palestinian from a city called Allod (اللد). My grandparents immigrated from their city to Ramallah, and I was born there.", timestamp: "00:01:15" },
      { speaker: "B", text: "I hold an architecture degree. I also see myself as a researcher – someone who seeks to explore and learn by experimenting and sharing knowledge.", timestamp: "00:01:37" },
      { speaker: "A", text: "We walked through Ein Qiniya together, and you were showing me the land. Through movement, when you are guiding someone through this place, what do you pay attention to that a visitor might miss?", timestamp: "00:02:00" },
      { speaker: "B", text: "I like to point out the general context – the larger city that a village resides in, and the various factors affecting the village itself. This includes urban and planning perspectives, as well as settler colonialism, especially because it is a very small village near Ramallah.", timestamp: "00:02:20" },
      { speaker: "B", text: "I also point out the ecology of the mountain: the history of the nature, the placement of the mountain, and the story behind the place – which is often a family story. I believe that is a massive part of the importance that resides in the land.", timestamp: "00:02:55" },
      { speaker: "A", text: "Does this include how you describe the land to people who don't know it? I'm a foreigner. I was mainly situated in Bethlehem, then moving around the West Bank, also visiting Hebron. These places were not far from each other, but each area has a different story. You mentioned Area A, B, and C, and how occupation affects mobility and everyday movement. For example, I was aware that some protected nature parks are not accessible to Palestinians with Palestinian ID.", timestamp: "00:03:25" },
      { speaker: "A", text: "The way you spoke of the plants as we walked up the mountain felt connected to the movement itself. How do you think knowledge changes when it is shared while walking rather than in a fixed place? Are there things about the land that only become clear when you are in motion with someone else?", timestamp: "00:04:25" },
      { speaker: "B", text: "I love this question. There is an important figure in Palestinian history, Khalil al‑Sakakini, who proposed the idea of learning through walking. This is very present in Palestinian practice and community life. His ideas later inspired educators like Muneer Fasheh, who founded the Tamer Institute for Community Education in Ramallah.", timestamp: "00:04:50" },
      { speaker: "B", text: "There is a group called Tijwal Safar (تجوال سفر) – which translates more closely to 'walking' or 'travelling' rather than just wandering. Their vision is to walk and to learn, moving through different villages and learning from local people who explain the place. Even during travel, like in a bus, we talk about passing mountains, historical events, and places connected to them.", timestamp: "00:05:15" },
      { speaker: "B", text: "Personally, being in motion while sharing information makes knowledge absorb more intuitively and stay longer in memory. When you are physically present, you connect information to the landscape – to plants, stones, and details you would otherwise miss. It becomes more connected and embodied.", timestamp: "00:05:55" },
      { speaker: "B", text: "Each person notices different things depending on their background – architecture, plants, or other interests. That difference creates conversation and shared understanding. I think that is the power of walking: observing, noticing, and being present without necessarily speaking.", timestamp: "00:06:40" },
      { speaker: "A", text: "When we were walking together and I was recording the soil – do you remember I was using that device to record the electromagnetic frequencies in the soil? What was going through your head at the time?", timestamp: "00:07:20" },
      { speaker: "B", text: "I remember thinking how interesting it is to hear something from beneath. Usually you hear things from above, especially because we were focusing on the tree, which I believe is a living thing. It felt very sentimental to do that. I was wondering how it might sound – whether like an echo or like water moving between air and soil.", timestamp: "00:07:50" },
      { speaker: "B", text: "I remember feeling curious about the result and how you would interpret it. I loved the methodology. It was also interesting to see a tool I had never encountered before.", timestamp: "00:08:35" },
      { speaker: "A", text: "Did I let you hear the sound? Basically it is a buzzing, an electrical buzz, very intense, and it shifts when you move around the soil. But then I realised I am not sure how much of the sound was from my own electricity.", timestamp: "00:09:05" },
      { speaker: "B", text: "I remember that conversation, because you had to repeat one of the recordings. I remember you had doubts in one of the measurements. I believe I was talking and then I went silent, and you repeated it.", timestamp: "00:09:45" },
      { speaker: "A", text: "Actually, it wasn't you speaking that I had to repeat the recording for. It is because the device cannot really capture voices. It captures a wide spectrum of electromagnetic frequencies and noise. For example, if you have a bad wire at home and hear buzzing – it is that kind of sound but more magnified and noisy.", timestamp: "00:10:15" },
      { speaker: "B", text: "I understand. I was thinking that I might have a high frequency when wearing certain fabrics that generate static electricity, and that I have this kind of energetic connection with people. Even though I have very cold hands in summer and winter, I don't know why it happens – so I have this idea of having a high frequency.", timestamp: "00:11:00" },
      { speaker: "B", text: "When I was recording the soil, I realised I wasn't sure how much control I had over electromagnetic readings, but I began thinking differently about frequency and presence. Even when humans touch the soil, it still picks up the current. It becomes a kind of living field of interaction.", timestamp: "00:12:00" },
      { speaker: "B", text: "I also love walking barefoot on places I feel connected to, especially when I have an intense moment and want to preserve a memory strongly. I do it intentionally – on grass, soil, or stone – so I can feel and remember the place through my body.", timestamp: "00:12:45" },
      { speaker: "B", text: "I used to do this when going to the Dome of the Rock in Jerusalem, because I could not enter freely, so I would experience it through my feet. I cannot go often anymore due to permits and restrictions. Before, during Ramadan, there were more permissions, but since the war, access has become very limited. Even permits now require strong justification – medical or work-related – and even then it is difficult. It has been years since I could freely access some places.", timestamp: "00:13:25" },
      { speaker: "B", text: "It feels like a cycle of escalation and pause – events rising and then repeating again. There are moments where things peak and then shift again, affecting the whole region, especially Palestine. In my belief, this continues until a larger resolution or divine timing – insha'Allah.", timestamp: "00:14:40" },
      { speaker: "B", text: "Let me return to walking and sensory knowledge. How did you learn to read the land in this way through your upbringing and heritage?", timestamp: "00:15:35" },
      { speaker: "B", text: "Part of it comes from religious practice – removing shoes in sacred spaces and feeling direct contact with the ground. Another part comes from traditional practices like working with mud, hay, and water using our feet. There are also memories of texture, heat, and seasonal shifts – how the ground feels at different times.", timestamp: "00:16:05" },
      { speaker: "B", text: "My family also used plants for healing, like herbal remedies passed through generations. For example, a bitter plant called wood sage – جعدة (Je'dah) (Teucrium scorodonia) – my grandmother would give it to my mother for stomach aches. It was very bitter, but it worked.", timestamp: "00:17:00" },
      { speaker: "B", text: "We also spent time in springs and open landscapes, feeling grass and soil barefoot during family gatherings. Even my mother is very connected to this sensory relationship with the land – walking in rain, touching soil, engaging directly with nature.", timestamp: "00:17:40" },
      { speaker: "B", text: "It is about connection through feet and hands – the first contact points with the world. Sometimes I feel an urge to touch textures and surfaces to understand their energy or material presence. It is about embodied memory – how physical contact creates stronger recollection.", timestamp: "00:18:20" },
      { speaker: "B", text: "Even walking in different environments creates different kinds of memory depending on sensation and movement. I remember walking with you and pointing out plants, learning through observation while moving. Even in winter, when fewer plants are visible, the landscape still carries knowledge and history.", timestamp: "00:19:00" },
      { speaker: "B", text: "Local knowledge – from people who grew up in these mountains – carries deep ecological memory. The land has its own secrets, known through lived experience rather than formal study. We also use traditional plants for healing and daily life, passed through generations. These practices connect body, memory, and landscape – through touch, walking, and sensory engagement.", timestamp: "00:19:45" },
      { speaker: "A", text: "That is beautiful. You mentioned berry trees and seasonal food earlier. Can you tell me more about how food and seasonality connect to your sense of place?", timestamp: "00:20:45" },
      { speaker: "B", text: "Traditionally, every village would have its own berry tree, usually growing beside water sources. It is part of Palestinian traditional knowledge. We used to have one beside our house, but the owners sold the house, and the new people demolished the tree along with the house, then built a long residential building to rent out. So the tree disappeared through urbanisation and the shift toward a modern way of life.", timestamp: "00:21:05" },
      { speaker: "B", text: "Still, our parents maintain seasonal knowledge. They know when fruits come into season. In summer we have figs, cactus fruit, and walnuts at specific times. There is still a seasonal memory attached to food.", timestamp: "00:21:55" },
      { speaker: "B", text: "Right now is the season for Armenian cucumber (فَقُّوس faqqus) – a small pale green cucumber, less juicy, somewhere between a cucumber and a courgette. We harvest it once a year. We also have mulberry trees – both white and black varieties – and the leaves are used for cooking.", timestamp: "00:22:30" },
      { speaker: "A", text: "Do you eat the leaves?", timestamp: "00:23:15" },
      { speaker: "B", text: "Yes. This is the first year I saw my friend's mother cook them stuffed with rice. Personally, I had never eaten this before. Even though I consider myself knowledgeable about my culture, there is always something new you haven't tried.", timestamp: "00:23:20" },
      { speaker: "B", text: "Food belongs to specific regions and communities. Some dishes are very local. My grandmother never introduced us to certain meals, while my father still prefers very traditional dishes from his origin that others don't know. Each region has its own food identity – Nablus is known for kunafa, and fruits carry geography too, like Jaffa oranges.", timestamp: "00:23:55" },
      { speaker: "A", text: "Yes, Jaffa oranges became famous for export quality.", timestamp: "00:24:50" },
      { speaker: "B", text: "Exactly. They were selected because they could withstand long sea transport. Other oranges couldn't survive the journey. It wasn't just pesticides – it may also relate to how they were cultivated or their natural properties.", timestamp: "00:25:00" },
      { speaker: "B", text: "There is an Instagram page by friends of mine that documents original stories behind Palestinian heritage and memory. They work carefully and in detail. They also document history from the 48 lands (historic Palestine), which I didn't know much about because of limited access and resources.", timestamp: "00:25:35" },
      { speaker: "A", text: "Social media makes this exchange possible.", timestamp: "00:26:15" },
      { speaker: "B", text: "Yes, but in Palestine it also changes how we use the internet. We are careful about what we say. Sometimes we alter words slightly to avoid censorship. It makes us more cautious and constantly alert.", timestamp: "00:26:25" },
      { speaker: "B", text: "Even movement in daily life is affected. Sometimes we check if there are patrols or arrests in the area before leaving home. Living near settlements means constant uncertainty. There are checkpoints and gates everywhere. Routes change depending on closures. Sometimes a short journey becomes hours longer because roads are blocked. People joke – we call ourselves 'the nation of gates.'", timestamp: "00:27:00" },
      { speaker: "A", text: "I do like Palestinian humour. It's dark, but it helps.", timestamp: "00:27:55" },
      { speaker: "B", text: "When I left recently, I saw how much things had changed – more closures, more restricted areas. Some areas are reclassified under different legal or historical claims. It feels like freedom is constantly being worn down. I mostly hear it through the news now.", timestamp: "00:28:55" },
      { speaker: "A", text: "Social media relies a lot on algorithms, which largely depend on usage. There is a paradox – you feel reality from afar, but differently when you are there. Restriction on movement, but also small escapes – going to land, sitting, breathing, reconnecting.", timestamp: "00:29:45" },
      { speaker: "B", text: "Youth initiatives and cultural organisations try to preserve this connection. Some organisations focus on education because curricula are being altered – removing or changing historical and geographical content about Palestine. Even terms like 'Jerusalem is the capital' are removed. This affects younger generations who receive distorted information while also living through direct experiences of violence and displacement. The contradiction is intense.", timestamp: "00:30:35" },
      { speaker: "B", text: "Personally, my uncle was detained for eleven and a half years. It shaped my childhood deeply. My mother used to visit him early in the morning in prison, and I grew up adapting to that routine. There are also memories of violence – homes damaged, raids, and emotional trauma that stays with you. Even if not directly experienced, it shapes you psychologically. In Palestine, it is difficult to detach from what is happening, because everything is interconnected.", timestamp: "00:31:35" },
      { speaker: "B", text: "There seems to be a connection – even though from my perspective things are distant, eventually there is still a connection.", timestamp: "00:32:45" },
      { speaker: "B", text: "Yes. I believe that is why this paradox exists. Many contradictions live within Palestinians. But the level of suffering is different. People who experience gates every day are different from those who do not. People confronted by settlers stealing their homes daily are different from those who are not. The geographical factor also plays a major role – whether you live in a village or a city compound shapes the experience.", timestamp: "00:33:05" },
      { speaker: "A", text: "Thank you for sharing that. You really touched the fabric of these connections. Even when I visited for a short time, everybody seemed to know everyone. After one day, I would go somewhere outside Bethlehem, and someone would know someone I knew. I live in London, and people I know here also know people in Palestine.", timestamp: "00:34:10" },
      { speaker: "B", text: "Yes, this happens often. There is always a connection with someone, even if you have never met them. Different context, religion, or background does not remove that shared experience. There is always something in common between Palestinians. I think that is a kind of privilege. Even Palestinians abroad feel the same.", timestamp: "00:34:55" },
      { speaker: "A", text: "That is what I felt with you when you told me about your grandmother. The story of her immigration and struggle stayed with me. Her parents – your grandparents – were called 'the swimmers,' right?", timestamp: "00:35:45" },
      { speaker: "B", text: "Yes, the 'freedom swimmers.' That story stayed with me too. The idea of grandparents going through that struggle is very moving. I believe memory and experience are inherited, even genetically. I feel it myself.", timestamp: "00:36:10" },
      { speaker: "B", text: "I learned to swim, but my body does not like water. My grandmother could not swim either, but somehow she did. We don't really know how she managed it. I think it is survival instinct.", timestamp: "00:36:50" },
      { speaker: "B", text: "In our culture there are similar stories. A mother hit by a car still stands up and takes her child to the hospital, even with broken legs. It is instinct to save her child. The same applies to ancestors. My grandmother lost a baby during her migration journey. She never spoke about it. She was very strong – I rarely saw her cry. She always spoke about returning home. She kept the house key with her all the time. She was also very social, always visiting neighbours even when she could barely walk. That created strong community ties.", timestamp: "00:37:25" },
      { speaker: "B", text: "My mother learned many things from her, including cooking traditional meals. We are still living the continuation of her presence through food and practices.", timestamp: "00:38:45" },
      { speaker: "A", text: "The grandmother really holds the family together.", timestamp: "00:39:15" },
      { speaker: "B", text: "Yes. We also have a saying: the mother is a collector, a gathering force.", timestamp: "00:39:25" },
      { speaker: "A", text: "Let me ask one more question. You mentioned restrictions and checkpoints. Have you noticed certain areas changing quickly, especially between Area A, B, and C?", timestamp: "00:40:15" },
      { speaker: "B", text: "Yes. Area C has changed significantly. Places that were once open for picnics are now forbidden. After recent events, accessing them can put people in direct danger. Farmers can no longer reach their olive trees. They have lost food sources and income. In some cases, people are shot or threatened when trying to access land.", timestamp: "00:40:35" },
      { speaker: "B", text: "Even when permissions exist, they are sometimes ignored. There are also time restrictions on land access – sometimes people are only given a few hours to harvest olives, and even that is not always respected. These are only small examples of a larger reality.", timestamp: "00:41:25" },
      { speaker: "B", text: "Movement within cities has also changed significantly in the last few years. It is accelerating quickly. There are also legislative developments and policies being discussed that are concerning, including tensions around Jerusalem and religious sites. There are excavations beneath the area they claim is historically significant to them.", timestamp: "00:42:05" },
      { speaker: "B", text: "These actions escalate political and religious tensions. They are linked to broader patterns across the West Bank. It is all interconnected. There is a belief that these events will continue in cycles. It can feel both grounding and unsettling at the same time.", timestamp: "00:42:55" },
      { speaker: "A", text: "You are referring to a phrase from religious text, right?", timestamp: "00:43:40" },
      { speaker: "B", text: "Yes. It connects the spiritual and political dimensions. They are not separate. There is also a responsibility to resist – through knowledge, presence, walking the land, and sharing stories. Even small acts matter. Resistance is also daily life: cooking, planting, speaking, and sharing all contribute. It is about refusing normalisation.", timestamp: "00:43:48" },
      { speaker: "A", text: "That is interesting, because narratives are also controlled elsewhere. But stories still circulate through different channels. Resistance can also be psychological – it can be joy, memory, or simply continuing life.", timestamp: "00:44:40" },
      { speaker: "B", text: "Yes. Even small acts like weddings or walking through gates carry meaning.", timestamp: "00:45:15" },
      { speaker: "A", text: "If someone only knew Palestine through maps or descriptions, what would they miss?", timestamp: "00:45:30" },
      { speaker: "B", text: "A map cannot show how close everything really is. When you are there, you realise how close settlements are to villages, how close gates are to houses, and how much conflict is physically present in the landscape. Even things that are not physical leave a physical trace on the ground.", timestamp: "00:45:45" },
      { speaker: "B", text: "A closed gate can cause traffic across the whole city. A shooting in the air can disturb the whole village. You might not know why the traffic is happening unless you know that a gate has been closed. You can suddenly smell gas bombs after a raid, or see vehicles passing by – all of that changes the atmosphere.", timestamp: "00:46:20" },
      { speaker: "B", text: "People in Gaza may have an even harder situation, but in the West Bank we are in constant contact with soldiers and settlers. That is its own form of pressure. The paradox is that everything is interconnected, and the feeling of freedom is constantly worn down – but people still find small ways to resist and remain connected to the land.", timestamp: "00:47:05" },
      { speaker: "B", text: "Living in a closed space – a big jail – is not life. Each person has their own geographical challenges. Someone who went on an aid mission to Gaza during the war has a different experience from someone in the West Bank, in refugee camps, or in places where settlers attack every day.", timestamp: "00:47:55" },
      { speaker: "B", text: "The sense of safety is very low in those areas because they are large open spaces with no authority to intervene. It is about surviving on your own. Settlers are often protected by the Israeli government when they attack. No one holds them accountable. That is why organisations are focusing more on these areas now – because people are being targeted and displaced.", timestamp: "00:48:45" },
      { speaker: "B", text: "Many people choose to leave because they cannot bear the harassment, or losing family members in raids and shootings – sometimes at 13 or 14 years old. Each suffering is different. The more you experience sensitive situations, the more you understand these different levels.", timestamp: "00:49:40" },
      { speaker: "B", text: "For me, it started with a visual connection. I grew up with the settlement as part of the landscape around me – a mountain where I knew a settlement existed. We never had direct confrontation with them. We knew when they had festivities because we could hear whistles or watch fireworks. That became part of my memory.", timestamp: "00:50:30" },
      { speaker: "B", text: "Later, it escalated into awareness of daily movement. A patrol from the settlement could go out, raid someone, attack someone, or arrest someone just because they wanted to. It adds up. And here I am speaking as someone privileged – this is the extent of my suffering. It is not nothing, but it is not more than that.", timestamp: "00:51:20" },
      { speaker: "B", text: "In Masafer Yatta, in Hebron, people are being targeted in a much more escalated way. They are trying their best. You can also see it in the way Palestinians in the 48 lands have lived from a young age inside this paradox – seeing settlers every day, dealing with them in school and daily life.", timestamp: "00:52:15" },
      { speaker: "B", text: "I cannot imagine marrying someone from there, because I worry about raising children who can handle all those layers. Should I tell them not to look at settlers? Should I tell them that their existence matters? Or should I not compromise their safety? It has many layers, especially in the 48 lands.", timestamp: "00:53:10" },
      { speaker: "B", text: "I feel compassion towards them. There is systemic violence funded by the Israeli government to keep them in rupture – not allowing them any sense of unity or the ability to focus on what is important. It becomes only about survival: trying not to be killed, thinking only about food. That is very unfortunate.", timestamp: "00:54:05" },
      { speaker: "B", text: "Then there is the geography – this big prison metaphor. And then the deeper layer of the community itself, how diverse it is. It has been shaped by layers of events: 1967, 1948, 1936, the Jordanian era. It creates a complex yet harmonious fabric between people.", timestamp: "00:55:00" },
      { speaker: "B", text: "There are cities, camps, and neighbours, all connected. The West Bank still has a strong sense of villages. Before 1948, a city had its own villages that were part of it. Now people are divided. My friend is from the same city as I am, but her family has people who migrated to the West Bank and others who migrated to Gaza – the same family exists in two different worlds.", timestamp: "00:55:55" },
      { speaker: "B", text: "One decision from a grandparent affected generations, just because they chose a certain geographical direction. It is intimidating. Sometimes you don't think about these things – you just follow instinct or the connections you have.", timestamp: "00:57:00" },
      { speaker: "B", text: "My grandmother walked to Lydd, but some of her relatives continued to Jordan and stayed there. Her sister and brothers are all in Jordan, while her direct family stayed there. She also has cousins in Ramallah – because she married my grandfather, she stayed in Ramallah. It is intense.", timestamp: "00:57:40" },
      { speaker: "B", text: "Someone who never visited Palestine would miss the human and sensory experience. It is really about walking. The arrival itself tells you a lot. When you head to the Jordanian border and pass through Jericho, you start hearing the words before seeing them. You hear 'should we go this route or that route?' Then you hear the word 'gate' – and you know something is happening. There are keywords you learn.", timestamp: "00:58:30" },
      { speaker: "B", text: "It is not for the weak. Palestinians who are deep in it don't always realise how intense it is. I used to feel it was nothing. But I didn't realise how intense the small things were until I saw how people who had never experienced it viewed it – as intimidating and not normal.", timestamp: "00:59:30" },
      { speaker: "B", text: "Palestinians have developed amazing adaptive skills to keep going as things escalate. Even though it is not always easy. Major changes – like losing your job because you cannot relocate your family near your workplace – can be devastating. It can push people into poverty or circumstances no one should have to bear. Many people have experienced that.", timestamp: "01:00:20" },
      { speaker: "B", text: "Not to mention people from Gaza stuck in the West Bank, and the workers. A large percentage of people used to work in the 48 lands. My father was one of them – he worked in a settlement. After the war started, he stopped completely. He is very systematic and cannot handle how inaccurate things can be for Palestinians, so he would rather not work at all.", timestamp: "01:01:15" },
      { speaker: "B", text: "The first sign is the paperwork itself. As soon as you start preparing the papers, you begin to feel the intensity. The way they check your profile and ask for your reasons gives you an idea. The decision to go for it starts telling you about the situation. But above all, it is a human connection and a sensory experience.", timestamp: "01:02:15" },
      { speaker: "A", text: "The effort to come to Palestine took me about a year to prepare for. I didn't know exactly when I would come, but I prepared everything in advance. I am very good with technology, so I had to make sure I could get in the right way. I did not want to take any other route.", timestamp: "01:03:10" },
      { speaker: "B", text: "The Palestinian Authority is corrupted, yes. The way people rely on it now is complicated. They recently had internal elections and different committees were elected, but much corruption happened. Certain people were chosen without clear reason. The Authority has no real authority. Settlers and soldiers can pass through and raid areas that are supposed to be protected. They can detain anyone they want, anytime, without consequence.", timestamp: "01:04:00" },
      { speaker: "B", text: "It is coordinated. The Authority knows, but cannot interfere because of the agreement. It is just an image of authority. They have escalated so far, and the Authority cannot do anything – not even object. Now it is more about services. That is why many people boycotted the elections. Some did not want to participate because they do not trust the body that is supposed to represent them.", timestamp: "01:05:05" },
      { speaker: "B", text: "For me, it was better to try than to watch them put whoever they want in place. I would rather try to counter that and challenge their arrangement. I would rather sign the paper – even if it does not really represent me – because I know my values and people know who I am. I would rather act than stand by and watch.", timestamp: "01:06:10" },
      { speaker: "B", text: "I can sense that you are tired. But I have one more thing.", timestamp: "01:07:05" },
      { speaker: "A", text: "It is fine. I want to know how you see this project. It is a broad project about the conditions of the air, multispecies sensing, and awareness of the ground and soil through movement. How would you like to see it moving forward? What would you like it to become?", timestamp: "01:07:15" },
      { speaker: "B", text: "That is a beautiful question. I feel that the researcher should decide the form. I am very aware – I told my school: I do not want this research to be something I just take back to Britain and keep there. I told them it would only be activated in Palestine first, not second. I do not want to continue extracting knowledge.", timestamp: "01:07:55" },
      { speaker: "B", text: "I have the privilege of going to Palestine to do this research, while most Palestinians cannot because of surveillance and control. I would rather not become another kind of coloniser or foreigner who uses a British passport to do the same thing – even if I have the right words to contextualise it. That does not matter. That is why I am asking you. It matters to me to know the agency of the people I work with, and how they see the project becoming.", timestamp: "01:08:45" },
      { speaker: "B", text: "It is not about telling me what to do. It is about being aware of values. I was thinking how beautiful it is that you are asking that. For me, I can imagine you making workshops, exhibitions, walks and talks, farming sessions, and cooking events. You have a multidisciplinary perspective. You merge technical ideas with stories, land, myths, and recordings. It is really amazing.", timestamp: "01:09:50" },
      { speaker: "B", text: "It is hard to balance the technical and the intangible. You could write a report about frequencies and recordings, or a text about stories and situations. But it is also beautiful to create walks and talks in Palestine – an experience that people remember. I could see it becoming exhibitions, workshops, events, walks, sketches, or a journal. Maybe a story – a full day with reflections.", timestamp: "01:10:50" },
      { speaker: "B", text: "Maybe the first thing you hear when you reach Palestine is the sound of a drone. People would understand the layers you are working with. Maybe we could create a community around it – a day within your vision, recording sounds and sensory experiences. It would raise awareness of human connection to themselves. Sometimes we move through the day without noticing what we hear, see, or touch. This keeps you grounded in what is actually happening around you.", timestamp: "01:11:55" },
      { speaker: "B", text: "Sometimes you don't realise that you heard a bullet that day. At the end of the day, you suddenly remember: 'I heard a bullet today.' This is why it is interesting. I am just brainstorming.", timestamp: "01:13:05" },
      { speaker: "A", text: "No, this is great. The sensory aspect matters: smell, light, texture, listening to dialects, voices, and tiny everyday sounds. I was always curious to know if the sounds of birds were disappearing. Birdwatchers listen for them all the time, because knowing they are disappearing means listening for them. Then you start to feel something missing – a sound absent from daily life. Maybe a plant is not growing as it should, or there are fewer olives to pick. That is what I meant by sounds disappearing from daily life.", timestamp: "01:13:45" },
      { speaker: "B", text: "Yes, I understand. The sound experience in Palestine is very different, especially over the last three years. A routine has been introduced during the war: whistles blown when there is an airstrike. You hear it and think, 'An airstrike. What do we do? Nothing, because we don't have shelters.' There is nothing to do but hear it and wait. Sometimes the sound of the strike reaches the ground and shakes the house if it is close enough.", timestamp: "01:15:10" },
      { speaker: "B", text: "The sound experience in Palestine is intense. Many people are very sensitive to sound. Children can tell whether a shot is a bullet or a rubber bullet. They know if it is a gas bomb. That is not normal – they learn the difference from a young age. The same goes for missiles. In Gaza it is another level entirely, because people there are directly struck. We were adjacent to the strikes.", timestamp: "01:16:10" },
      { speaker: "B", text: "In the last few years, we were introduced to a more sensitive sensory experience of hearing. The whistles are especially important because settlements are everywhere. When an attack happens, you hear whistles from all around. In Hebron, for example, we know a strike is coming because a nearby settlement has blown its whistle – a warning so they can hide in shelters. About three minutes later, the strike happens.", timestamp: "01:17:15" },
      { speaker: "B", text: "At first the whistles warned us, but later they stopped working properly or came too late. Then they installed counter-attack batteries around the settlements to react faster. That led to rocket fragments falling in Palestinian areas. People were injured, some lost their houses. This technology was meant to intercept attacks, but it spread damage across the West Bank.", timestamp: "01:18:25" },
      { speaker: "B", text: "In Hebron, during Eid after Ramadan, women were at a salon preparing for the festival. Fragments from a counter-attack fell on them. Three women were killed – one pregnant, another a cancer patient. It was miserable. We began to feel the strikes more, and people became worried even about walking outside.", timestamp: "01:19:30" },
      { speaker: "B", text: "During the elections, we were on a tour when the settlement whistles started. People told me to move to the side. I stayed standing, and they shouted at me to come over. 'What are you doing? Come here. It might happen.' I didn't realise at first. That moment was intense – it made me feel how real it is. At home, it is more about hearing what might happen. But when I went out there, I realised it was much more than hearing.", timestamp: "01:20:30" },
      { speaker: "B", text: "The regularity of these disruptions can make them feel normal. Your body thinks: 'It's the same sound. Nothing happened the other day, so why would it happen today?' That is exactly what I meant. Some voices and sounds become familiar and then disappear over time.", timestamp: "01:21:35" },
      { speaker: "B", text: "For me, bird culture is one of them. I am lucky that I live near the graveyard – there are many trees, and I hear birds at dawn. That is part of my hearing experience. Then there are the birds privately owned at home. The birds I hear at dawn are the natural ones from the graveyard. The house birds are more active during the day or when guests come – they are part of special interactions.", timestamp: "01:22:20" },
      { speaker: "B", text: "It may not be common for people to relate to the sound experience like this. But if you switch that awareness on, people would start noticing what they hear and what is missing. Observing over time eventually leads to recognising sounds that disappear. Even smells can trigger memory in the same way.", timestamp: "01:23:25" },
      { speaker: "A", text: "The common myna is an invasive species introduced by the Israelis. You see it in Palestine and parts of the West Bank. It is an Indian bird that the Israelis released. It kills other birds and mimics the sound of a swallow – it also kills their babies. When I came back to Britain, I heard swallows and was instantly reminded of the common myna. I thought: 'These are the real swallows, not the copycats.' So you also have bird occupiers – the invasive species version of settler occupation.", timestamp: "01:24:15" },
      { speaker: "B", text: "It is interesting to see what our ears become attuned to – to understand sounds that are not natural, and the frequencies we are exposed to all the time. I believe part of why Palestinians have a higher tone of speech is related to the frequencies they are constantly attuned to. Daily life is always high-frequency, so it shapes the way people speak. That high frequency is not only in the voice but in the body too – it puts the body into a constant state of stress and survival, because you are always being alerted.", timestamp: "01:25:30" },
      { speaker: "A", text: "There is no room for planning. You have to move when something becomes available, because you don't always know when checkpoints will open. Time itself is occupied. Settlers and Israelis use time as a weapon against Palestinians. From my experience, resistance is also about reclaiming time. Time works differently there – 'late' is not the same as late, and 'early' is not the same as early.", timestamp: "01:26:45" },
      { speaker: "B", text: "Yes. My aunt lives in a village near Ramallah. Since the gates were put up, family gatherings always feel rushed. She comes at a certain time, her husband arrives at another time. They have to leave before the gate closes. Yesterday, they left on time, but when they reached the gate, it was closed. They had to return to a park and stay there until the gate opened again. It affects us even when we don't consciously notice it.", timestamp: "01:27:55" },
      { speaker: "B", text: "While we were talking, I realised how much our time feels occupied once the gate is open. We are always stressed that she might think we are late. For us, we can come at 11, but for her 11 is too late – we should come at 9 to meet her, because she has a curfew before the gate closes. She also wants to see us before her husband comes to pick her up.", timestamp: "01:29:05" },
      { speaker: "A", text: "That is a beautiful point – that resisting somehow reclaims time. What exactly does that mean, reclaiming time?", timestamp: "01:30:15" },
      { speaker: "B", text: "Despite time being constrained by restrictions, you reclaim it by making your own form of time. No one else controls it for you. For example, in Bethlehem, when I planned my research, I felt like I had no control over time at all. It depended on what was available – but not in a simple public sense. It was based on a collective and individual sphere. I had to let go and adapt. Sometimes you just push and do it – don't wait, just go.", timestamp: "01:30:35" },
      { speaker: "A", text: "That makes you more of a doer. If you plan too much, you might oversleep and miss the right time to get out before traffic. So you move when you can, and see if there is a lot of traffic or not.", timestamp: "01:31:55" },
      { speaker: "B", text: "Exactly. A few days ago, I drove to a farther area than usual with my mother. We had to go to a funeral. On the third day, we planned to leave at 5:15 so we could get home, change clothes, and reach the road before traffic or a gate closure. We left earlier than we should have, but when we got home and moved later, there was traffic. The car stopped in the middle of traffic. It was the first time that happened, but I just said, 'Okay, this is not the first time the car does this.' I put on the hazard lights and it worked. I didn't panic.", timestamp: "01:32:30" },
      { speaker: "B", text: "You have certain expectations, but you adapt to how things actually go. You end up relieved that you made it where you wanted to go. Every time it becomes a different experience. That is what keeps Palestinians going – every time you think, 'Let's see what happens this time,' because it is never the same scenario. There are so many factors shaping each moment. Even if you schedule a meeting, you need to allow for the possibility that something might happen. I would leave two hours early just in case.", timestamp: "01:33:50" },
      { speaker: "B", text: "That is one of the skills people develop, especially those who commute a lot. Many people have rented or bought apartments in Ramallah because they can no longer bear commuting from Nablus or from nearby villages. They settle in their work area – it is easier than going through checkpoints every day. On weekends, there is always traffic because people are going to see their families.", timestamp: "01:35:10" },
      { speaker: "A", text: "Thank you so much. You gave me so much information.", timestamp: "01:36:25" },
      { speaker: "B", text: "I am glad it helped.", timestamp: "01:36:40" },
      { speaker: "A", text: "I really miss Palestine in my research.", timestamp: "01:36:50" },
      { speaker: "B", text: "I hope your meetings with people there will be very beneficial too. There are many multidisciplinary works that connect with what you are doing. In my last days at Saqia, we collaborated with a Palestinian cultural arts centre. They designed a dance using the feet and senses in a very embodied way – a dance with a strong concept behind it. Each scene held its own symbol and story through experience.", timestamp: "01:37:05" },
      { speaker: "B", text: "When you come, you could sit with the choreographer and reflect on it as an echo of sensing, story, and history. It was intense for me as the coordinator – we were filming, the sun kept coming and going, we watched the wind and predicted where clouds would move, waiting for the right light. There was also the sound experience – we played Palestinian songs with a wide sonic range.", timestamp: "01:38:10" },
      { speaker: "B", text: "Then there was a final scene with bullet sounds. I was terrified that the settlement might send a drone for us. I didn't know the soundtrack originally, and I worried about how safe it was. They observed us all day. If they wanted to stop us, they would have done it at the beginning. It was an intense sensory experience. When the bullet sound came, I was terrified – but thankfully nothing happened.", timestamp: "01:39:10" },
      { speaker: "B", text: "The dance was beautiful. In one part, they used their hands in mud and put material on each other's faces – a scene where they were buried in the ground, then revived, cleaning each other. If they finish it before you come, or when you come, it would be good to mention it.", timestamp: "01:40:10" },
      { speaker: "A", text: "It sounds beautiful.", timestamp: "01:41:10" },
      { speaker: "B", text: "Yes, it really is.", timestamp: "01:41:20" },
      { speaker: "A", text: "I think we should stop here. It is already very late. You must be exhausted.", timestamp: "01:41:30" },
      { speaker: "B", text: "My schedule has been like this since I became free, so it is okay. It is within my bedtime. I still wanted to ask you more, but I need to think better about the questions.", timestamp: "01:41:45" },
      { speaker: "A", text: "Thank you again. This has been incredibly valuable.", timestamp: "01:42:15" },
      { speaker: "B", text: "Thank you. I hope your meetings with people there will be very beneficial.", timestamp: "01:42:25" },
    ],
  },
];
